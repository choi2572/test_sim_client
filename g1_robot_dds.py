    ...
    def write_robot_state(
        ...
        *,
        ...
        Args:
            ...
            ee_qpos: optional 17-float sequence (see tasks/common_observations/g1_29dof_state.py)
            ee_state_6d: optional 23-float proprio matching unifolm-vla RLDS ee_state_6d
        """
        ...
        try:
            ...
            if ee_qpos is not None:
                state_data["ee_qpos"] = (
                    ee_qpos.tolist() if hasattr(ee_qpos, 'tolist') else list(ee_qpos)
                )
            if ee_state_6d is not None:
                state_data["ee_state_6d"] = (
                    ee_state_6d.tolist() if hasattr(ee_state_6d, 'tolist') else list(ee_state_6d)
                )
